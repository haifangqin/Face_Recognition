...
from data import test_fddb_args
...
def Align(img_path):
    ...
    for i in range(len(scores)):
        if scores[i]> args.confidence_threshold:
            ...
            continue
    print('with confidence score {}, detect {} faces'.format(args.confidence_threshold,len(index))) 
    if len(index) == 0:
    ...
    return aligned_list,bbox_list,scores
