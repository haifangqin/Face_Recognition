...
test_fddb_args.trained_model = './weights/detection_model/Resnet50_Final.pth' #'./weights/mobilenet0.25_Final.pth'
test_fddb_args.network = 'resnet50'#'mobile0.25'
test_fddb_args.save_folder = 'eval/'
test_fddb_args.cpu = False
test_fddb_args.dataset = 'FDDB'
test_fddb_args.confidence_threshold = 0.95#0.02
test_fddb_args.top_k = 5000
test_fddb_args.nms_threshold = 0.1
