...
pip install opencv-python==4.6.0.66 Pillow==8.3.1 typing-extensions==3.10.0.0 requests==2.25.1 scikit-image==0.17.2 mxnet-neuron==1.5.1.1.6.1.0 scikit-learn==0.24.2 torch==1.11.0 easydict==1.9 torchvision==0.12.0
# for face quality
